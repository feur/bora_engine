...
class MyAccount(object):
    ...
    def CheckOrder(self):  
        ...
        if (self.DogeOrder == 1 and self.OrderPrice > float(1.04 * self.DogePrice)): ##Doge Price has gone down by 4% 
        ...
        elif (self.DogeOrder == 2 and self.OrderPrice < float(0.96 * self.DogePrice)): ##Doge Price has gone down by 4% 
